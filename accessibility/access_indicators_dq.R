...
data_dir <- Sys.getenv("GW_RDD") |>
  file.path("UPRN/distance to nearest green space mag")
...
greenspace_distances <-
  file.path(data_dir, "uprn_greenspace_distances.csv") |>
  readr::read_csv()
# tidy up the data
...
greenspace_distances_v3 |>
  ...
  readr::write_excel_csv(file.path(data_dir, "UPRN_2_1_greenspace_distances.csv"))
## with coordinates
greenspace_distances_v3 |>
  readr::write_excel_csv(file.path(data_dir, "UPRN_2_1_greenspace_distances_with_coords.csv"))
...
greenspace_distances_v3 <- file.path(data_dir, "UPRN_2_1_greenspace_distances_with_coords.csv") |>
  readr::read_csv()
...
ggplot2::ggsave(
  filename = file.path(data_dir, "UPRN_2_1_greenspace_distances_any_greenspace.png"),
  width = 12,
  height = 11,
  dpi = 300
)
...
ggplot2::ggsave(
  filename = file.path(data_dir, "UPRN_2_1_greenspace_distances_doorstop_greenspace.png"),
  width = 12,
  height = 11,
  dpi = 300
)
...
ggplot2::ggsave(
  filename = file.path(data_dir, "UPRN_2_1_greenspace_distances_local_greenspace.png"),
  width = 12,
  height = 11,
  dpi = 300
)
...
ggplot2::ggsave(
  filename = file.path(data_dir, "UPRN_2_1_greenspace_distances_neighbourhood_greenspace.png"),
  width = 12,
  height = 11,
  dpi = 300
)
...
ggplot2::ggsave(
  filename = file.path(data_dir, "UPRN_2_1_greenspace_distances_wider_greenspace.png"),
  width = 12,
  height = 11,
  dpi = 300
)
...
ggplot2::ggsave(
  filename = file.path(data_dir, "UPRN_2_1_greenspace_distances_district_greenspace.png"),
  width = 12,
  height = 11,
  dpi = 300
)
...
ggplot2::ggsave(
  filename = file.path(data_dir, "UPRN_2_1_greenspace_distances_subregional_greenspace.png"),
  width = 12,
  height = 11,
  dpi = 300
)
